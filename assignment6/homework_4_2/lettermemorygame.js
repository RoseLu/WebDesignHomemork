...
pictures[0].src="img/y0.png";
pictures[1] = new Image();
pictures[1].src="img/y1.png";
pictures[2] = new Image();
pictures[2].src="img/y2.png";
pictures[3] = new Image();
pictures[3].src="img/y3.png";
pictures[4] = new Image();
pictures[4].src="img/y4.png";
pictures[5] = new Image();
pictures[5].src="img/y5.png";
pictures[6] = new Image();
pictures[6].src="img/y6.png";
pictures[7] = new Image();
pictures[7].src="img/y7.png";
pictures[8] = new Image();
pictures[8].src="img/y8.png";
pictures[9] = new Image();
pictures[9].src="img/y9.png";
